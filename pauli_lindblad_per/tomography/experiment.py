...
class SparsePauliTomographyExperiment:
    ...
    def __init__(self, circuits, inst_map, backend, tomography_connections=False, sum_over_lambda=False):
        ...
        if tomography_connections:
            ...
            connection_map = [connection for connection in processor.quantum_processor.qubit_topology().to_directed().edges() if any([used_qubit in connection for used_qubit in used_qubits])]
